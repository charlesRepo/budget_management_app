...
5. Fill in the environment variables:
   ...
   | `FRONTEND_URL` | `https://your-app-name.onrender.com` | Same as your app URL (no /api) |
   | `AUTHORIZED_EMAILS` | `email1@gmail.com,email2@gmail.com` | Comma-separated list of allowed emails |
...
# Authorized Emails (comma-separated, no spaces around commas)
AUTHORIZED_EMAILS=your-email@gmail.com,partner-email@gmail.com
...
The app uses a two-layer authorization system:

**1. Google OAuth Test Mode (Recommended for personal/family use)**
- Keep your OAuth app in "Testing" mode in Google Cloud Console
- Add authorized users under "Test users" in OAuth consent screen
- Google blocks unauthorized users before they reach your app
- No code changes needed

**2. Server-Side Authorization (`AUTHORIZED_EMAILS`)**
- Add `AUTHORIZED_EMAILS` environment variable with comma-separated email list
- Example: `user1@gmail.com,user2@gmail.com`
- Server rejects any email not in the list, even if they pass Google OAuth
- Provides an extra security layer

**Best Practice**: Use BOTH methods for maximum security.
